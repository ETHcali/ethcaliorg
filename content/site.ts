...
// ── swag ────────────────────────────────────────────────────────────────────
//
// The catalogue itself lives in Supabase (`swag_products` plus its Shopify and
// onchain variant tables) and is read by `lib/content.ts#getSwagCatalogue`.
// Only the ways to earn it stay here — they are copy, not stock.
